...
class _StringsDe implements _StringsEn {
	...
	@override String get example => 'Ein Beispiel für die Verwendung von locale_switcher';
	@override String get chooseLanguage => 'Bitte wählen Sie die Sprache aus';
	@override String get increment => 'Erhöhen';
	@override String get counterDescription => 'Sie haben den Knopf so oft gedrückt:';
	@override String get showIcons => 'Symbole anzeigen: ';
	@override String get circleOrSquare => 'Kreis oder Quadrat: ';
}
...
class _StringsVi implements _StringsEn {
	...
	// Translations
	@override late final _StringsMainScreenVi mainScreen = _StringsMainScreenVi._(_root);
	@override String get example => 'Một ví dụ về cách sử dụng locale_switcher';
	@override String get chooseLanguage => 'Vui lòng chọn ngôn ngữ';
	@override String get increment => 'Tăng';
	@override String get counterDescription => 'Bạn đã nhấn nút này nhiều lần:';
	@override String get showIcons => 'Hiển thị biểu tượng: ';
	@override String get circleOrSquare => 'Tròn hoặc vuông: ';
}
...
class _StringsMainScreenVi implements _StringsMainScreenEn {
	...
	// Translations
	@override String get title => 'Tiêu đề Tiếng Viet';
	@override String counter({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('vi'))(n,
		one: 'Bạn đã nhấn ${n} lần.',
		other: 'Bạn đã nhấn ${n} lần.',
	);
	@override String get tapMe => 'Chạm vào tôi';
}
...
extension on _StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'example': return 'An example of usage of locale_switcher ';
			case 'chooseLanguage': return 'Please choose language';
			case 'increment': return 'Increment';
			case 'counterDescription': return 'You have pushed the button this many times:';
			case 'showIcons': return 'Show icons: ';
			case 'circleOrSquare': return 'Circle or square: ';
			default: return null;
		}
	}
}
...
extension on _StringsDe {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'example': return 'Ein Beispiel für die Verwendung von locale_switcher';
			case 'chooseLanguage': return 'Bitte wählen Sie die Sprache aus';
			case 'increment': return 'Erhöhen';
			case 'counterDescription': return 'Sie haben den Knopf so oft gedrückt:';
			case 'showIcons': return 'Symbole anzeigen: ';
			case 'circleOrSquare': return 'Kreis oder Quadrat: ';
			default: return null;
		}
	}
}
...
extension on _StringsVi {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'mainScreen.title': return 'Tiêu đề Tiếng Viet';
			case 'mainScreen.counter': return ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('vi'))(n,
				one: 'Bạn đã nhấn ${n} lần.',
				other: 'Bạn đã nhấn ${n} lần.',
			);
			case 'mainScreen.tapMe': return 'Chạm vào tôi';
			case 'example': return 'Một ví dụ về cách sử dụng locale_switcher';
			case 'chooseLanguage': return 'Vui lòng chọn ngôn ngữ';
			case 'increment': return 'Tăng';
			case 'counterDescription': return 'Bạn đã nhấn nút này nhiều lần:';
			case 'showIcons': return 'Hiển thị biểu tượng: ';
			case 'circleOrSquare': return 'Tròn hoặc vuông: ';
			default: return null;
		}
	}
}
