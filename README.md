...
Unlike `locale_switcher`, it required a few more lines to set up, but allow you to control 
which flags are included (or none) and which packages it depend on (or none). See setup below.
...
- [ ] Support slang
- [ ] reduce assets: `build` to manage assets
